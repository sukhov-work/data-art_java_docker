...
public class ReflectUtils {
    ...
    public static Method findInterfaceMethod(Class iface) {
        ...
        System.out.println(iface.getMethods());
        if (methods.length != 1) {
            System.err.println("override single interface method check for: "+ iface.getName());
            return methods[0];
    ...
    public static Class defineClass(String className, byte[] b, ClassLoader loader,
        ...
        if (c == null) {
            System.err.println("tried to define class: " + className);
